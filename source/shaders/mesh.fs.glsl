...
//diffuse calculations
    ...
    vec3 diffuse = diff_color * light.color.xyz * light.power * clamp(dot(n, l), 0, 1) / (dist * dist);
...
//specular calculations
    ...
    vec3 specular = spec_color * light.specular * light.color.xyz * 
        light.power * pow(clamp(dot(e, r), 0, 1), 10) / (dist*dist);
